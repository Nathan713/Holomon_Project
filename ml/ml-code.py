...
prevUp = 0
up = 0
path = Path("/home/pi/handy/holomon assets/idlePikachu.mp4")
player = OMXPlayer(path)
# process = subprocess.Popen(['omxplayer','/home/pi/handy/holomon assets/idlePikachu.mp4'])
...
while True:
    ...
    #Below is used to determine location of the joints of the fingers 
     ...
     if up == 5 and prevUp != up:
         #player.stop()
         command1 = "sudo killall -s 9 omxplayer.bin"
         os.system(command1)
         path = Path("/home/pi/handy/holomon assets/pikachu3.mp4")
         player = OMXPlayer(path)
         
         #process.kill()
         
#          process = subprocess.Popen(['omxplayer','/home/pi/handy/holomon assets/pikachu3.mp4'])
         
     elif up == 4 and prevUp != up:
         #player.stop()
#          process.kill()
#          process = subprocess.Popen(['omxplayer','/home/pi/handy/holomon assets/pikachu2
         command1 = "sudo killall -s 9 omxplayer.bin"
         os.system(command1)
         path = Path("/home/pi/handy/holomon assets/pikachu2.mp4")
         player = OMXPlayer(path)
     elif up == 1 and prevUp != up:
         #player.stop()
#          process.kill()
#          process = subprocess.Popen(['omxplayer','/home/pi/handy/holomon assets/pikachu1.mp4'])
         command1 = "sudo killall -s 9 omxplayer.bin"
         os.system(command1)
         path = Path("/home/pi/handy/holomon assets/pikachu1.mp4")
         player = OMXPlayer(path)
     else:
         try:
             player.is_playing()
